        ...
        columns: [
          ...
          },
          {
            images: [
              ...
              { src: 'https://cdn.freebiesupply.com/logos/thumbs/2x/java-logo.png', color: '#fff3b0' },
              { src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/Python.svg/480px-Python.svg.png', color: '#9ef01a' },
