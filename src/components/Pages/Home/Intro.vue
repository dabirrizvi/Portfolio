...
export default {
  data() {
    return {
      typedHeading: '',
      introContent: "Welcome to my portfolio! I’m a Full-Stack Software Engineer with over three years of experience building scalable e-commerce platforms and modern web applications, specialising in Magento 2, Hyvä, PHP, and JavaScript. I have extensive experience developing custom modules, integrating third-party services, modernising legacy systems, and delivering high-performance solutions using technologies including Node.js, React, Vue.js, PostgreSQL, MongoDB, Elasticsearch, and cloud-based development tools. Holding an MSc in Advanced Computer Science and a Bachelor of Engineering in Electronics and Communication, I’m passionate about solving complex technical challenges, building maintainable software, and continuously learning new technologies. Explore my portfolio to discover the projects, research, and professional work that showcase my technical expertise and commitment to delivering innovative software solutions.",
