...
export default {
  data() {
    return {
      typedHeading: '',
      introContent: "Welcome to my portfolio! I'm a result-driven Software Developer with a diverse skill set that encompasses web-based applications, artificial intelligence, and machine learning. With a strong academic background, including an MSc in Advanced Computer Science and a Bachelor of Engineering in Electronics and Communication, and over two years of hands-on experience in agile teams, I am dedicated to bringing creativity and efficiency to the world of software development. My journey has led me to become proficient in object-oriented programming, with a strong emphasis on web-based applications. I'm technologically savvy, and my unwavering drive to excel fuels my ambition to contribute effectively to any organisation's success. Explore my portfolio to discover the projects that reflect my dedication to the ever-evolving fields of software development and AI/ML.",
