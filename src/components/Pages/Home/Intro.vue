        ...
        <li>
          <kinesis-container>
            <kinesis-element :strength="10" type="depth">
              <!-- Linkedin -->
              <a target="_blank" href="https://www.linkedin.com/in/dabir-hasan-rizvi-738a83185/"><i
                  class="fa-brands fa-linkedin fa-socials"></i></a>
            </kinesis-element>
          </kinesis-container>
...
export default {
  data() {
    return {
      typedHeading: '',
      introContent: "Welcome to my portfolio! I am a dynamic and results-driven Software Engineer with over two years of experience in agile environments, specialising in backend and web-based application development using technologies such as PHP and Node.js. I have strong expertise in database design and optimisation, particularly with MongoDB and PostgreSQL, and experience building scalable APIs and robust web applications. I have worked extensively with Magento (Adobe Commerce), developing custom modules, integrating third-party services, and optimising eCommerce platforms for performance and scalability. Holding an MSc in Advanced Computer Science and a Bachelor of Engineering in Electronics and Communication, I am passionate about delivering innovative software solutions through collaboration and continuous learning. Explore my portfolio to see projects that highlight my technical skills and commitment to driving organisational success.",
