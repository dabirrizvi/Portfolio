  ...
  <div class="background">
    <div class="row content-container intro-content-container" >
      <h2 data-aos="fade-in">Embarking on a Technological Odyssey</h2>
        <p class="intro-content" data-aos="fade-left">Navigating the dynamic intersection of technological ingenuity and hands-on
        ...
        <p class="intro-content" data-aos="fade-right">My professional odyssey thrives in the collaborative heartbeat of agile teams.
        ...
        <p class="intro-content" data-aos="fade-left">At the core of my endeavors lies an unyielding passion for innovation in artificial
        ...
        <p class="intro-content" data-aos="fade-right">My enthusiasm for technology transcends the theoretical, finding expression in each
        ...
        <p class="intro-content" data-aos="fade-left">Embark on a journey through my portfolio to witness the practical dimensions of my
